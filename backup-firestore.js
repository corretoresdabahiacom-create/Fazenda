...
async function backup() {
  ...
  const collections = [
    'users', 'animals', 'pastures', 'expenses',
    'payments', 'tasks', 'inventory', 'employees',
    'fixedExpenses', 'weighingSheets'
  ];
  ...
  console.log(`📂 Tamanho: ${(statSync(filename).size / 1024 / 1024).toFixed(2)} MB`);
}

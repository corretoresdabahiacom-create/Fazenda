...
const SECTIONS: Section[] = [
  {
    ...
    content: [
      ...
      'Se a cidade não estiver informada, aparece o link "Detectar minha localização" — pede permissão do navegador e preenche sozinho, via GPS.',
  ...
  },
  {
    ...
    title: 'Cotações',
    content: [
      'No topo, mostra o câmbio comercial (compra e venda) do Dólar, Euro, Iene, Ouro e Bitcoin em tempo real, direto do Banco Central e de outras fontes oficiais.',
      'Toque em "Produto selecionado" para abrir a lista completa de produtos (Boi Gordo, Vaca, Novilha, Café Arábica/Conilon, Algodão, Soja, Milho, Trigo, Laranja, Açúcar, Suínos, Frango, Leite, Arroz, Feijão, Cacau, Amendoim, Sorgo, Ovos, Mandioca, Frutas e mais) — escolha e toque em "Ok" para carregar.',
      'Escolha o estado no primeiro campo para restringir a lista de cidades disponíveis; o campo de busca ao lado mostra sozinho as cidades que realmente têm dado para o produto escolhido. O botão "Usar minha localização" preenche isso automaticamente.',
      'Se a cidade exata não tiver dado, o app busca o local mais próximo (mesmo estado) antes de cair no preço geral do Brasil — sempre avisando qual dos três casos aconteceu.',
      'Os resultados aparecem em 3 blocos, sempre nessa ordem: 🇧🇷 Preço Atual no Brasil, depois 📈 Futuro B3, e por fim 🌍 Mercado Internacional (com o preço equivalente nos Estados Unidos via CBOT/ICE/CME — Europa e China ainda não têm fonte gratuita confiável disponível).',
      'Quando você digita uma cidade específica (com o estado selecionado), aparece também um bloco "📍 Cotações em [cidade] (Agrolink)" — uma fonte com cobertura por município exato, que complementa os dados principais.',
      'Os dados vêm de fontes públicas do mercado (CEPEA/ESALQ, B3, Scot Consultoria, Datagro, IMEA, Agrolink), consolidadas principalmente pelo Notícias Agrícolas — os links para as fontes completas ficam no fim da tela.',
    ],
  },
  {
    icon: Building2,
  ...
  },
  {
    ...
    content: [
      ...
      '"Estação de Monta" organiza o período concentrado de reprodução (monta natural ou IA/IATF) — data de início, duração (60 a 120 dias, 90 é o mais recomendado), touros usados, proporção touro:vaca e lote de fêmeas. A taxa de prenhez é calculada sozinha a partir dos diagnósticos já registrados em Reprodução, e o início avisa na Central de Obrigações.',
  ...
  },
  {
    ...
    content: [
      ...
      '"Pulverização Programada" planeja aplicações futuras com os parâmetros da receita agronômica: produto, alvo, dose, taxa de aplicação (L/ha), equipamento, carência antes da colheita e intervalo de reentrada na área. Avisa na Central de Obrigações conforme a data se aproxima, e mostra o aviso de clima do dia quando a data programada é hoje.',
  ...
  },
  {
    ...
    content: [
      ...
      '"Usuários" lista todas as contas, com busca, filtro por status (incluindo teste grátis 3 dias, teste estendido 7 dias, e inatividade de 30/60/90 dias), e botões para ativar, suspender, bloquear, cancelar ou excluir qualquer uma. O botão "Sincronizar todos os usuários do Firebase" traz de uma vez todas as contas já cadastradas, mesmo as que nunca apareceram na lista antes.',
